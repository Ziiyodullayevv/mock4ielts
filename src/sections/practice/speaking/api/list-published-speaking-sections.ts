...
export type SpeakingPracticeListItem = {
  difficulty: SectionDifficulty;
...
export type SpeakingPracticeSectionsResult = {
  items: SpeakingPracticeListItem[];
  pagination: PaginationDto;
};
...
export async function listPublishedSpeakingSections(): Promise<SpeakingPracticeSectionsResult> {
