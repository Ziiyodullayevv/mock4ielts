    ...
    >
      ...
      <div className="relative z-20 mx-auto flex h-full w-full max-w-[19rem] flex-col items-center justify-center px-6 text-center sm:max-w-none sm:px-6">
        <motion.div
          ...
          className="mb-8 hidden h-10 w-23 items-center justify-center rounded-full bg-white/80 shadow-[0_18px_38px_rgba(15,23,42,0.08)] backdrop-blur-md sm:flex dark:bg-white/15 dark:shadow-none"
        >
        ...
        <motion.p
          ...
          className="text-[22px] font-medium leading-none tracking-[-0.04em] text-stone-700 sm:text-[36px] dark:text-white/82"
        >
          Join Our
        </motion.p>
        ...
        <motion.h2
          ...
          className="mt-2 text-[3rem] font-semibold leading-[0.92] tracking-[-0.07em] text-stone-950 sm:mt-4 sm:text-[72px] lg:text-[92px] dark:text-white"
        >
          Community
        </motion.h2>
        ...
        <motion.div
          ...
          className="mt-9 flex w-full max-w-[16rem] flex-col items-center gap-3 sm:mt-10 sm:max-w-none sm:flex-row sm:justify-center"
        >
          <Button
