...
const PersonaWithModel = memo(
  ({ rive, source, lightColor, children }: PersonaWithModelProps) => {
    ...
    useEffect(() => {
      ...
      const [r, g, b] = theme === "dark" ? [255, 255, 255] : (lightColor ?? [0, 0, 0]);
      viewModelInstanceColor.setRgb(r, g, b);
    }, [viewModelInstanceColor, theme, source.dynamicColor, lightColor]);
...
export const Persona: FC<PersonaProps> = memo(
  ({
    ...
    return (
      <Component rive={rive} source={source} lightColor={lightColor}>
