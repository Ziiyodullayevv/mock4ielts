...
export function TokenIcon({ className, monochrome = false, ...props }: TokenIconProps) {
      ...
      {!monochrome ? (
        <defs>
          <linearGradient
            ...
            y2="12.8333"
          >
            <stop offset="0.0001" stopColor="#FFC85A" />
            <stop offset="0.55" stopColor="#FF9F2F" />
            <stop offset="1" stopColor="#FF784B" />
          </linearGradient>
        </defs>
      ) : null}
    </svg>
