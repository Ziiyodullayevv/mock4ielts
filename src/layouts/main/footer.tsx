...
export function MainFooter() {
  ...
  return (
    <section className={isHomePage ? 'relative bg-black pb-10 md:py-16' : 'relative bg-black py-6'}>
      <div className="mx-auto max-w-6xl px-6 md:px-4">
        ...
        <div className="flex justify-between border-t border-t-white/8 pt-5 text-sm text-white48 sm:flex-col sm:gap-2 sm:text-center">
