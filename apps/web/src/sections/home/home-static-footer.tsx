...
export function HomeStaticFooter() {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="relative bg-background py-10 text-foreground sm:py-12 md:py-16 dark:bg-black dark:text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        <div className="text-center">
          ...
          <form className="relative mx-auto mb-4 max-w-lg">
            <div className="relative flex items-center gap-2 rounded-[32px] border border-transparent bg-[#ededed] p-2 shadow-[0_18px_40px_rgba(15,23,42,0.08)] backdrop-blur-[10px] sm:rounded-[50px] sm:p-0 dark:border-white/40 dark:bg-white/[0.24] dark:shadow-none">
              <input
                type="email"
                required
